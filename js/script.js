...
function changeInnerHtml() {
  ...
  if ($(window).width() < 723) {
    element.text("Ø§Ø³ØªÙ…ØªØ¹ Ø¨Ø´ÙˆØ§Ø·Ø¦ Ø§Ù„Ø¨Ø­Ø± ÙÙŠ Ø§Ù„ØºØ±Ø¯Ù‚Ø©");
  } else {
    element.text("Ø§Ø³ØªØ¬Ù…Ø§Ù… Ø¹Ù„Ù‰ Ø´ÙˆØ§Ø·Ø¦ Ø§Ù„Ø¨Ø­Ø± Ø§Ù„Ø£Ø­Ù…Ø± ÙÙŠ Ø§Ù„ØºØ±Ø¯Ù‚Ø©");
  }
}
...
if ($(".land").length > 0) {
  ...
  // When the 'Ù…ÙˆØ§ÙÙ‚' button is clicked, close the selectWindow
